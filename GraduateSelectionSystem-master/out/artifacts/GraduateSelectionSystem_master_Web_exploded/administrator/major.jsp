						...
						<div class="article" style="text-align:center;vertical-align:middle">
							...
							<table class="tablestyle">
								...
								<s:iterator value="#request.majors" id="major">
									<tr>
										<td><a href="classService?id=<s:property value="#major.id" />"><s:property value="#major.id" /></a></td>
										<td><a href="classService?id=<s:property value="#major.id" />"><s:property value="#major.name" /></a></td>
										<td><a href="majorInfo!edit.action?id=<s:property value="#major.id" />">编辑</a>&nbsp;&nbsp;<a href="majorInfo!deleteMajor.action?major.id=<s:property value="#major.id" />">删除</a></td>
									</tr>
								</s:iterator>
							</table>
						<div class="pagenav">
								<ul>
									...
									<li><a href="majorService!addinit.action" class="btu">添加专业</a></li>
								</ul>
							</div>
						</div>
					</div>
