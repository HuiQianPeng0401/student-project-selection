		...
		<div class="wrapper linear">
			...
			<div class="container">
				...
				<div class="right">
					...
					<div class="table">
						<form action="configService!configupdate.action">
							...
							<div class="article">
								...
								<ul class="baseinfo">
									<li>学生最大选题数：
										<input type="text" name="config.stuMaxChoiceNum" value="<s:property value="#request.config.stuMaxChoiceNum"/>" required="required"/>
									</li>
									<li>教师平均指导数：
										<input type="text" name="config.teaGuidanceNum" value="<s:property value="#request.config.teaGuidanceNum"/>" required="required"/>
									</li>
									<li>教师最少出题数：
										<input type="text" name="config.teaMinTopicNum" value="<s:property value="#request.config.teaMinTopicNum"/>" required="required"/>
										
									</li>
									<li>每题限制学生选择数：
										<input type="text" name="config.topicChoiceLimit" value="<s:property value="#request.config.topicChoiceLimit"/>" required="required"/>
										
									</li>
									<li style="color: #FFFFFF;">
										可以通过对职称的设置，提高选题系统管理的需求，也可以对相应教师做出设置。
									</li>
								</ul>
								<div class="pagenav">
								<ul>
