		...
		<div class="wrapper linear">
			...
			<div class="container">
				...
				<div class="right">
					...
					<div class="table">
						<form action="adminInfo!modifyPW.action">
							<div class="article">
								<ul>
								<li style="color: #FFFFFF;"><s:property value="message"/></li>
								</ul>
								<ul class="baseinfo">
									<li>原密码<input type="password" id="oldPassword" name="oldPassword" value="${oldPassword}" required="required"/></li>
									<li>新密码<input type="password" id="newPassword1" name="newPassword1" value="${newPassword1}" required="required"/></li>
									<li>确认密码<input type="password" id="newPassword2" name="newPassword2" value="${newPassword2}" required="required"/></li>
									
							</ul>
								<div class="pagenav">
								<ul>
									<li><input type="submit" class="btu" value="确定修改"/></li>
								</ul>
								</div>
