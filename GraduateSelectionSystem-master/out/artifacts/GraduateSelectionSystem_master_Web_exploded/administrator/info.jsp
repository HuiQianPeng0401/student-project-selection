		...
		<div class="wrapper linear">
			...
			<div class="container">
				...
				<div class="right">
					...
					<div class="table">
						<form action="adminInfo!update.action">
							<div class="article">
								<ul>
								<li style="color: #FFFFFF;"><s:property value="message"/></li>
								</ul>
								<ul class="baseinfo">
									<li>ID:<input type="text" name="admin.id" value="<s:property value="#request.admin.id"/> " readonly="readonly"/></li>
									<li>昵称:<input type="text" name="admin.name" value="<s:property value="#request.admin.name"/>" required="required"/></li>
									<li style="padding-left: 40px;">超级用户:
										<s:if test="#request.admin.isSuper==1">
											<label>是</label>
										</s:if>
										<s:if test="#request.admin.isSuper==0">
											<label>否</label>
										</s:if>
									</li>
								</ul>
								<input type="hidden" name="admin.isSuper" value="<s:property value="#request.admin.isSuper"/>"/>
								<input type="hidden" name="admin.password" value="<s:property value="#request.admin.password"/>"/>
								<div class="pagenav">
								<ul>
									<li><input type="submit" class="btu" value="修改信息"/></li>
									<li><a href="adminInfo!modify.action" class="btu">修改密码</a></li>
								</ul>
								</div>
