					...
					<div class="table">
						...
						<div class="pagenav">
								<ul>
									...
									<li><a href="TopicChoice!frontPage.action?currentPage=<s:property value="#request.page.currentPage" />" class="btu">上一页</a></li>
									</s:if>
									...
									<li><a href="TopicChoice!nextPage.action?currentPage=<s:property value="#request.page.currentPage" />" class="btu"><s:property value="#request.page.currentPage+1" /></a></li>
									</s:if>
									<s:if test="#request.page.currentPage+2<=#request.page.totalPage">
									<li><a href="TopicChoice!nextPage.action?currentPage=<s:property value="#request.page.currentPage+1" />" class="btu"><s:property value="#request.page.currentPage+2" /></a></li>
									</s:if>
									<s:if test="#request.page.currentPage+3<=#request.page.totalPage">
									<li><a href="TopicChoice!nextPage.action?currentPage=<s:property value="#request.page.currentPage+2" />" class="btu"><s:property value="#request.page.currentPage+3" /></a></li>
									</s:if>
									<s:if test="#request.page.hasNextPage==true">
									<li><a href="TopicChoice!nextPage.action?currentPage=<s:property value="#request.page.currentPage" />" class="btu">下一页</a></li>
									<li><a href="TopicChoice!nextPage.action?currentPage=<s:property value="#request.page.totalPage-1" />" class="btu">最后一页</a></li>
									</s:if>
								</ul>
							</div>
						</div>
