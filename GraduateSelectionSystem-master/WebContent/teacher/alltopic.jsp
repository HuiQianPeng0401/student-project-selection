...
<html>
	...
	<body>
		<div class="header">
			...
			<div class="navsmall">
				<ul>
					<li><a href="TeacherService!teacherIndex.action" >首页</a></li>
					...
					<div class="table">
							...
							<table class="tablestyle">
								...
								<s:iterator value="#request.topics" id="topic">
									<tr>
										...
										<td>
											<s:if test="#topic.isCheck==2">
												<s:if test="#topic.isStuApply==1">
													<s:if test="#topic.isEnable==0">
														<a href="ChoiceStuTopic.action?id=<s:property value="#topic.id" />">选择</a>
													</s:if>
												</s:if>
											</s:if>
										</td>
						...
						<div class="pagenav">
								<ul>
									...
									<li><a href="TeacherChoice!frontPage.action?currentPage=<s:property value="#request.page.currentPage" />" class="btu">上一页</a></li>
									</s:if>
									...
									<li><a href="TeacherChoice!nextPage.action?currentPage=<s:property value="#request.page.currentPage" />" class="btu"><s:property value="#request.page.currentPage+1" /></a></li>
									</s:if>
									<s:if test="#request.page.currentPage+2<=#request.page.totalPage">
									<li><a href="TeacherChoice!nextPage.action?currentPage=<s:property value="#request.page.currentPage+1" />" class="btu"><s:property value="#request.page.currentPage+2" /></a></li>
									</s:if>
									<s:if test="#request.page.currentPage+3<=#request.page.totalPage">
									<li><a href="TeacherChoice!nextPage.action?currentPage=<s:property value="#request.page.currentPage+2" />" class="btu"><s:property value="#request.page.currentPage+3" /></a></li>
									</s:if>
									<s:if test="#request.page.hasNextPage==true">
									<li><a href="TeacherChoice!nextPage.action?currentPage=<s:property value="#request.page.currentPage" />" class="btu">下一页</a></li>
									<li><a href="TeacherChoice!nextPage.action?currentPage=<s:property value="#request.page.totalPage-1" />" class="btu">最后一页</a></li>
									</s:if>
								</ul>
							</div>
						</div>
