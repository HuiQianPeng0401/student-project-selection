							...
							<table class="tablestyle">
								...
								<s:iterator value="#request.choiceMaps" id="choiceMap">
									<tr>
										...
										<td><s:property value="#choiceMap.studentId" /></td>
										...
										<td>
											<s:if test="#request.topic.state==0">
												<a href="SelectStudent!accept.action?id=<s:property value="#choiceMap.id" />">接受</a>&nbsp;&nbsp;&nbsp;<a href="<s:property value="SelectStudent!refuse.action?id=#choiceMap.id" />">拒绝</a>
											</s:if>
											<s:else>已确定</s:else>
										</td>
									</tr>
