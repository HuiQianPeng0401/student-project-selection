					...
					<div class="table">
						<div class="article" style="text-align:center;vertical-align:middle">
							<table class="tablestyle">
								...
								<s:iterator value="#request.students" id="student">
									<tr>
										<td><a href="UserInfo.action?id=<s:property value="#student.id"/>&userType=student"><s:property value="#student.id" /></a></td>
										<td><s:property value="#student.name" /></td>
										<td><s:property value="#student.gender" /></td>
										<td><s:property value="#request.major.name" /></td>
										<td><s:property value="#request.clazz.name" /></td>
										<td>
											<s:if test="#student.autoMatch==0">否</s:if>
											<s:if test="#student.autoMatch==1">是</s:if>
										</td>
										<td>
											<s:if test="#student.isMatched==0">否</s:if>
											<s:if test="#student.isMatched==1">是</s:if>
										</td>
						...
						<div class="pagenav">
								<ul>
									...
									<li><a href="studentManage!frontPage.action?currentPage=<s:property value="#request.page.currentPage" />" class="btu">上一页</a></li>
									</s:if>
									...
									<li><a href="studentManage!nextPage.action?currentPage=<s:property value="#request.page.currentPage" />" class="btu"><s:property value="#request.page.currentPage+1" /></a></li>
									</s:if>
									<s:if test="#request.page.currentPage+2<=#request.page.totalPage">
									<li><a href="studentManage!nextPage.action?currentPage=<s:property value="#request.page.currentPage+1" />" class="btu"><s:property value="#request.page.currentPage+2" /></a></li>
									</s:if>
									<s:if test="#request.page.currentPage+3<=#request.page.totalPage">
									<li><a href="studentManage!nextPage.action?currentPage=<s:property value="#request.page.currentPage+2" />" class="btu"><s:property value="#request.page.currentPage+3" /></a></li>
									</s:if>
									<s:if test="#request.page.hasNextPage==true">
									<li><a href="studentManage!nextPage.action?currentPage=<s:property value="#request.page.currentPage" />" class="btu">下一页</a></li>
									<li><a href="studentManage!nextPage.action?currentPage=<s:property value="#request.page.totalPage-1" />" class="btu">最后一页</a></li>
									</s:if>
								</ul>
							</div>
						</div>
