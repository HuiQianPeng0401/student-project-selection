		...
		<div class="wrapper linear">
			...
			<div class="container">
				...
				<div class="right">
					...
					<div class="table">
						<form action="fieldInfo!update.action">
							...
							<div class="article">
								...
								<ul class="baseinfo">
									<li>ID:<input type="text" name="field.id" value="<s:property value="#request.field.id"/>" readonly="readonly"/></li>
									<li>班级名称:<input type="text" name="field.name" value="<s:property value="#request.field.name"/>" required="required"/></li>
									<li>领域描述:
										<textarea name="field.description" rows="5" cols="40"><s:property value="#request.field.description"/></textarea>
									</li>
								</ul>
								<div class="pagenav">
								<ul>
