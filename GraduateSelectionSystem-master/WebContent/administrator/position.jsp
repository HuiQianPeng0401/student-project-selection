						...
						<div class="article" style="text-align:center;vertical-align:middle">
							...
							<table class="tablestyle">
								...
								<tr style="color: #FFFFFF; width: 100%; background: #4169E1;">
									<td width="20%">ID</td>
									<td width="20%">名称</td>	
									<td width="20%">相对平均指导数水平</td>	
									<td width="10%">最大出题数</td>
									<td width="20%">操作</td>		
								</tr>
								...
								<s:iterator value="#request.positions" id="position">
									<tr>
										...
										<td><s:property value="#position.level" /></td>
										<td><s:property value="#position.maxQuestionNum" /></td>
										<td><a href="positionInfo.action?id=<s:property value="#position.id" />">编辑</a>&nbsp;&nbsp;<a href="positionInfo!delete.action?id=<s:property value="#position.id" />">删除</a></td>
									</tr>
								</s:iterator>
							</table>
						<div class="pagenav">
								<ul>
									...
									<li><a href="positionService!addinit.action" class="btu">添加职称</a></li>
								</ul>
							</div>
						</div>
					</div>
