					...
					<div class="table">
						<form action="MessageAction!send.action">
							<div class="article">
								...
								<ul>
									<li style="padding-left: 40px;">编号:<input type="text" name="message.sendId" value="<s:property value="#session.admin.id"/> " readonly="readonly"/></li>
									<li style="padding-left: 40px;">姓名:<input type="text" name="message.sendName" value="<s:property value="#session.admin.name"/>" readonly="readonly" /></li>
									...
									<input type="hidden" name="message.sendType" value="admin"/>
