		...
		<div class="wrapper linear">
			...
			<div class="container">
				...
				<div class="right">
					...
					<div class="table">
						<form action="classInfo!update.action">
							...
							<div class="article">
								...
								<ul class="baseinfo">
									<li>ID:<input type="text" name="clazz.id" value="<s:property value="#request.clazz.id"/>" required="required"/></li>
									<li>班级名称:<input type="text" name="clazz.name" value="<s:property value="#request.clazz.name"/>" required="required"/></li>
									<li>专业名称:<select name="clazz.majorId">
							   	                <option value="<s:property value="#request.clazz.majorId"/>" selected="selected"><s:property value="#request.major.name"/></option>
