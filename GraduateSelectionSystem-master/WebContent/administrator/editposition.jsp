		...
		<div class="wrapper linear">
			...
			<div class="container">
				...
				<div class="right">
					...
					<div class="table">
						<form action="positionInfo!update.action">
							...
							<div class="article">
								...
								<ul class="baseinfo">
									<li>ID:<input type="text" name="position.id" value="<s:property value="#request.position.id"/>" required="required" readonly="readonly"/></li>
									<li>职称名称:<input type="text" name="position.name" value="<s:property value="#request.position.name"/>" required="required"/></li>
									<li>相对平均指导数水平:<input type="text" name="position.level" value="<s:property value="#request.position.level"/>" required="required"/></li>
									<li>最大出题数:<input type="text" name="position.maxQuestionNum" value="<s:property value="#request.position.maxQuestionNum"/>" required="required"/></li>
								</ul>
								<div class="pagenav">
								<ul>
