						...
						<div class="article" style="text-align:center;vertical-align:middle">
							...
							<table class="tablestyle">
								...
								<s:iterator value="#request.fields" id="field">
									<tr>
										<td><s:property value="#field.id" /></td>
										<td><s:property value="#field.name" /></td>
										<td><s:property value="#field.description" /></td>
										<td><a href="fieldInfo.action?id=<s:property value="#field.id" />">编辑</a>&nbsp;&nbsp;<a href="fieldInfo!delete.action?id=<s:property value="#field.id" />">删除</a></td>
									</tr>
								</s:iterator>
							</table>
						<div class="pagenav">
								<ul>
									...
									<li><a href="fieldService!addinit.action" class="btu">添加领域</a></li>
								</ul>
							</div>
						</div>
					</div>
