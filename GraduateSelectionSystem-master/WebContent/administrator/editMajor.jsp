		...
		<div class="wrapper linear">
			...
			<div class="container">
				...
				<div class="right">
					...
					<div class="table">
						<form action="majorInfo!update.action">
							...
							<div class="article">
								...
								<ul class="baseinfo">
									<li>专业ID:<input type="text" name="major.id" value="<s:property value="#request.major.id"/>" readonly="readonly"/></li>
									<li>专业名称:<input type="text" name="major.name" value="<s:property value="#request.major.name"/>" required="required"/></li>
								</ul>
