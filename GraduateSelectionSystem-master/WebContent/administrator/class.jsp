						...
						<div class="article" style="text-align:center;vertical-align:middle">
							...
							<table class="tablestyle">
								...
								<s:iterator value="#request.clazzs" id="clazz">
									<tr>
										<td><a href="studentManage.action?id=<s:property value="#clazz.id" />"><s:property value="#clazz.id" /></a></td>
										<td><s:property value="#request.major.name" /></td>
										<td><a href="studentManage.action?id=<s:property value="#clazz.id" />"><s:property value="#clazz.name" /></a></td>
										<td><a href="classInfo!edit.action?id=<s:property value="#clazz.id" />">编辑</a>&nbsp;&nbsp;<a href="classInfo!delete.action?id=<s:property value="#clazz.id" />">删除</a></td>
									</tr>
								</s:iterator>
							</table>
						<div class="pagenav">
								<ul>
									...
									<li><a href="classService!addinit.action" class="btu">添加班级</a></li>
								</ul>
							</div>
						</div>
					</div>
